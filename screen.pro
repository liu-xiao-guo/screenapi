...
UBUNTU_TRANSLATION_DOMAIN="screen.liu-xiao-guo"
...
aptest.commands = bash $$PWD/screen/tests/autopilot/run
aptest.depends  = sub-screen

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/screen/tests/unit
unittest.depends  = sub-screen
